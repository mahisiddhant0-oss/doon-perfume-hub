...
import { CheckCircle2, Truck, Calendar, ArrowRight, ExternalLink } from "lucide-react";
  ...
  if (loading)
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--color-brand-bg)]">
        <div className="animate-pulse text-[var(--color-brand-primary)] font-serif text-2xl">
          Confirming your fragrance...
        </div>
      </div>
    );
              ...
              {order?.awbNumber ? (
                <div className="bg-green-50 p-4 rounded-lg flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-green-700 mt-1">Delhivery ID: {order.awbNumber}</p>
                    <Link
                ...
                <div className="bg-blue-50 p-4 rounded-lg flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700 mt-1">
                      We&apos;re verifying your payment and preparing your package.
                    </p>
                  </div>
                </div>
              )}
